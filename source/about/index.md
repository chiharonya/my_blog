...
<div class="chiron-profile-grid">
  <section>
    <span>现在关注</span>
    <strong>AI应用开发、vibe coding、个人知识库</strong>
  </section>
  <section>
    <span>写作原则</span>
    <strong>尽力而为，实用主义</strong>
  </section>
  <section>
    <span>更新节奏</span>
    <strong>看心情</strong>
...
<div class="chiron-topic-list">
  <div>
    <h3>技术实践</h3>
    <p>记录学习技术过程遇到的问题与解决方式，防止自己忘记，供日后查阅，顺便帮助遇到同样问题的人。</p>
  </div>
  <div>
    <h3>项目记录</h3>
    <p>保留从想法到实现的路径，也记录那些中途改主意的原因。</p>
  </div>
  <div>
    <h3>测评万物</h3>
    <p>动画/游戏/影视/消费品，什么都会写，只要我认为值得一写。</p>
  </div>
  <div>
    <h3>日常片段</h3>
    <p>想到啥写啥，记录日常。</p>
...
<ol class="chiron-roadmap">
  <li><strong>站点基础</strong><span>完成首页、归档、分类、标签和关于页，让访问路径先稳定下来。</span></li>
  <li><strong>内容结构</strong><span>梳理文章分类与标签规则，避免以后越写越乱。</span></li>
